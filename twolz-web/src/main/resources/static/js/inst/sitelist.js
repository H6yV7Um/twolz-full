...
function doAdd() {
    ...
    var dataObj = JSON.stringify({siteMobile:siteMobile,siteName:siteName,cfuscc:cfuscc,state:state,address:address});
...
function doUpdate(){
    ...
    var address = $('#address').val();
    var state = $(":radio[name='state']:checked").val();
    var dataObj = JSON.stringify({id:siteId,siteMobile:siteMobile,siteName:siteName,cfuscc:cfuscc,state:state,address:address});
    $.ajax({
        processData: false,
        type: 'POST',
        url: "/siteinfo/update",
...
function formtemplate(data){
    ...
    $("#siteInfoForm").validation({icon: false});
}
